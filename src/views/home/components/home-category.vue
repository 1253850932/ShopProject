    ...
    <div class="home-category">
        <ul class="menu">
            <li v-for="item in menuList" :key="item.id" @mouseenter="categoryID = item.id">
                ...
                <template v-if="item.children">
                    <RouterLink v-for="(sub, index) in item.children" :key="sub.id" :to="`category/sub/${sub.id}`">{{ sub.name }}</RouterLink>
                </template>
                <template v-else>
        ...
        <div class="layer">
            ...
            <ul v-if="currCategory && currCategory.brands && currCategory.brands.length">
                <li class="brand" v-for="brands in currCategory.brands" :key="brands.id">
                    <RouterLink to="/">
                        <img v-lazyload="brands.picture" alt="" />
                        <div class="info">
